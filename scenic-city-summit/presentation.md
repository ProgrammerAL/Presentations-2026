...
section::before {
  /* display: block; */
  content: url('https://raw.githubusercontent.com/ProgrammerAL/Presentations-2026/main/confoo-2026/coding-csharp-with-csharp/presentation-images/duende-logo-rebranded.svg');  width: 10px;
  height: 10px;
